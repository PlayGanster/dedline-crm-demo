...
import { ArrowLeft, Download, Send, FileText, Building2, Calendar, Printer } from "lucide-react";
...
export default function ActDetailPage() {
  ...
  const handleDownload = () => {
    const content = "АКТ №" + mockAct.number + " от " + mockAct.date + "\n\nКлиент: " + mockAct.client + "\nСумма: " + formatMoney(mockAct.amount) + "\nСтатус: " + statusLabels[mockAct.status];
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold">Акт №{mockAct.number}</h1>
            <p className="text-sm text-slate-500">от {mockAct.date}</p>
          </div>
        </div>
