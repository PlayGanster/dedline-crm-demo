...
import { ArrowLeft, User, Building2, Mail, Phone, Save, MessageSquare } from "lucide-react";
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold">Создание клиента</h1>
          <p className="text-sm text-slate-500">Добавление нового клиента в базу</p>
        </div>
      </div>
