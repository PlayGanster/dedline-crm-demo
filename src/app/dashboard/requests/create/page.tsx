...
import { ArrowLeft, Save, Mail, Phone, MapPin, FileText, Users, MessageSquare } from "lucide-react";
...
export default function ApplicationCreatePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    budget: "",
    city: "",
    client_id: clientIdParam ? parseInt(clientIdParam) : 0,
    manager_id: 1,
    supervisor_id: 1,
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold">Создание заявки</h1>
          <p className="text-sm text-slate-500">Добавление новой заявки</p>
        </div>
      </div>
        ...
        <Card>
          ...
          <CardContent>
            <Textarea
              ...
              placeholder="Дополнительный комментарий для исполнителей..."
              rows={3}
            />
          </CardContent>
        </Card>
